...
class Args:
    ...
    def initialize(parser):
        # args for path
        parser.add_argument('--output_dir', default='../ckpt/MultiClass/',
                            help='the output dir for model checkpoints')

        parser.add_argument('--bert_dir', default='./model/bert-base-chinese/',
        ...
        # other args
        parser.add_argument('--num_tags', default=8, type=int,
                            help='number of tags')
